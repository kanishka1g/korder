<template>
	<div class="modern-table-container">
		...
		<div class="table-controls">
			<!-- Top Section: Title/Slot and Primary Actions -->
			...
			<!-- Secondary Section: Search and Selection Summary -->
					...
					>
						<VCardText class="pa-4">
							<div class="mobile-item-content">
								...
								<!-- Item Fields in 2-Column Layout -->
								<VRow no-gutters class="mobile-fields-grid">
									<VCol
										v-for="header in visibleHeaders"
										:key="header.key"
										cols="12"
										class="mobile-field-row"
									>
										<VRow no-gutters align="center" class="field-row">
											<VCol cols="5" class="field-label-col">
											...
											<VCol cols="7" class="field-value-col">
